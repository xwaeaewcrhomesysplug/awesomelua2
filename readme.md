...
- [luatx](https://github.com/daurnimator/luatz) - Time, date, and timezone library.(wrong name)
...
- [Hammerspoon](http://www.hammerspoon.org) - A powerful, extensible OS X automation tool. A community-maintained fork of [Mjolnir](https://github.com/sdegutis/mjolnir).(http://www.mjolnir.io/)<old link
...
###Jan2021_updates by others.(Simple merge unsorted)
...
- [premake](https://github.com/premake/premake-core) - Describe your software project just once, using Premake's simple and easy to read syntax, and build it everywhere.
- [Programming Community Curated Resources For Learning Lua](https://hackr.io/tutorials/learn-lua) - A list of recommended resources for learning Lua.
- [Repo for stuff test implementations of Lua]https://github.com/xwaeaewcrhomesysplug/LuaRI_publictestsuite
